...
public class MaterialEditText extends EditText {
  ...
  */
  ...
  private void initMinBottomLines() {
    ...
    currentBottomLines = minBottomLines = 1;// minBottomTextLines > 0 ? minBottomTextLines : extendBottom ? 1 : 0;
  }
  ...
  @SuppressLint("NewApi")
    ...
    // >> Vuze: There's some problem with the code above on Lollipop
    // causing some widgets to have way too much height.  The width is somehow
    // wrong, so the number of lines requires is large.
  ...
  protected void onDraw(@NonNull Canvas canvas) {
    ...
    if (floatingLabelEnabled && !TextUtils.isEmpty(floatingLabelText)) {
      ...
      textPaint.setColor((Integer) argbEvaluator_evaluate(focusFraction, getCurrentHintTextColor(), primaryColor));
   ...
   */
  public Object argbEvaluator_evaluate(float fraction, Object startValue, Object endValue) {
